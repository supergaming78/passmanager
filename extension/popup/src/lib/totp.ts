...
//
// Copie CONFORME de frontend(app)/src/lib/totp.ts (logique pure, aucune adaptation) — les deux
// côtés DOIVENT produire le même code au même instant, un écart rendrait l'un des deux inutilisable.
