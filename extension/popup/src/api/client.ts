...
/** Enregistre une utilisation de l'entrée (copie du mot de passe ou remplissage automatique) pour
 * le tri "le plus utilisé" (voir VaultEntry.use_count). À appeler en best-effort, SANS attendre sa
 * réponse avant de continuer l'action réelle (copier/remplir). */
...
// handlers/admin.rs côté backend) : masquer ces boutons côté client est une commodité d'UX, jamais
